...
app.post("https://fz-fb-server.onrender.com/statuses", function (request, response) {
...
app.delete("https://fz-fb-server.onrender.com/statuses/:id", function (request, response) {
